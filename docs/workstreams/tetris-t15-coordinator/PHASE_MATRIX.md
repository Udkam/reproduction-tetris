...
| 3. HUD | `t15_hud_writer` | `t15_hud_rules_qa` + `t15_hud_visual_qa` | DOM/input/a11y, spawn presentation, and final HUD CSS remain separately revertible | `CONTRACT`; rollback `6892f80`, baseline/pre-audit complete, source not started |
