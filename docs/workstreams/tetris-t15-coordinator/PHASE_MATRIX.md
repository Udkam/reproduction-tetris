...
| 4. Survival | sequential `t15_survival_core_writer`, `t15_survival_render_writer`, `t15_survival_ui_writer` | `t15_survival_rules_qa` + `t15_survival_visual_qa` | Core, renderer, and UI each receive their own candidate SHA | `CONTRACT`; rollback `1383fca`, source not started |
