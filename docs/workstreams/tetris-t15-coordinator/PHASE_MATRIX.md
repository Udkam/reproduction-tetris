...
| 6. Classic | coordinator; product source frozen at corrected Renderer candidate | first `t15_classic_rules_qa` returned one P2; repeat rules, then visual/evidence QA strictly serial | contract `7aed5ef`; ordinary clear `1a163ff`; feedback contract `fee0627`; cues `a1f3d1b`; rejected candidate `eaed1ac`; correction contract/source `308e49c` / `9085976`; fresh gates/evidence; repeated QA; acceptance | `CORRECTION SOURCE FROZEN / FRESH GATES NEXT`; direct 30/30 + typecheck PASS; browser/QA remain closed |
