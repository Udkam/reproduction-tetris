...
| 4. Survival | sequential `t15_survival_core_writer`, `t15_survival_render_writer`, `t15_survival_ui_writer` | `t15_survival_rules_qa` + `t15_survival_visual_qa` + `t15_survival_evidence_qa` | Core `514c459`, renderer `4d31994`, HUD `f89c040`, records `5c6a436`, clock `cc8c71f`, score proof `2af2adf` | `CORRECTED-QA`; evidence `993dfc7`, rollback `1383fca`, repeated verdicts pending |
