...
| 6R. Direct ordinary-clear rollback | coordinator | `t15_phase6_rules_qa` | clean-line source `760437d`; current-schema fixture `9730d99`; title-only correction `70cff6e`; rejected selector history preserved separately at `dce331b` | `SOURCE CANDIDATE / GATES PENDING`; selector product paths are unchanged from remote |
