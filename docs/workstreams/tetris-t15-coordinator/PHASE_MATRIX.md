...
| 8. Integration | coordinator | `t15_final_rules_qa` + `t15_final_visual_qa` + `t15_final_evidence_qa`; tie-break if needed | contract; source-bound current-head browser raw; manifest/hashes; three serial QA verdicts; acceptance/recovery | `CONTRACT / PRODUCT FROZEN`; candidate `4e4cca1`, selector redesign excluded |
