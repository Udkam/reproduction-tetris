...
| 6. Classic | coordinator as `t15_classic_writer`; product and evidence are frozen | `t15_classic_rules_qa` + `t15_classic_visual_qa` + `t15_classic_evidence_qa`, strictly serial | contract `7aed5ef`; ordinary clear `1a163ff`; feedback contract `fee0627`; cues `a1f3d1b`; landing correction/final source `eaed1ac`; gates `55e5a7b` / `fb9ccc2` / `50e3693`; final harness `1b9c85f`; raw/index `a231fda` / `d7fb4fa`; QA; acceptance | `EVIDENCE FROZEN / SERIAL QA NEXT`; candidate `eaed1ac` over base `4f871ac`; 15 inspected frames, 19 hashes, zero errors/leaks; product/evidence closed |
