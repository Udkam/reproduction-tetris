...
| 6. Classic | coordinator as `t15_classic_writer`; all product source is frozen | `t15_classic_rules_qa` + `t15_classic_visual_qa` run serially after candidate freeze | contract `7aed5ef`; ordinary clear `1a163ff`; feedback contract `fee0627`; cues `a1f3d1b`; landing correction/final source `eaed1ac`; gates; evidence; QA; acceptance | `SOURCE FROZEN / GATES NEXT`; candidate `eaed1ac` over base `4f871ac`; Core, UI/CSS/audio, Puzzle data/selector and other-mode effects frozen |
