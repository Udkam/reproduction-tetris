...
| 2. Settings | coordinator as `t15_settings_writer` | `t15_settings_rules_qa` + `t15_settings_visual_qa` + `t15_settings_evidence_qa` | behavior/content and layout/style are separate checkpoints | `CONTRACT`; base `fd26652`, three read-only pre-audits complete |
