...
| --- | --- | --- | --- | --- |
| 1. Design foundation | coordinator as `t15_phase1_writer` | `t14_readonly_qa` + `phase1_visual_delta` | contract, dependency, token/font source, evidence, QA, acceptance | `CORRECTED CANDIDATE 99e5a0f`; repeated dual audit pending |
