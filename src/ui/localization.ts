  ...
  'zh-CN': {
    ...
    rules: {
      ...
      race: [
        ...
        { id: 'stonefall', label: '落石', value: '20 秒开始，每次缩短 1 秒至 10 秒；同列双石以方块 2 倍速度坠落。' },
  ...
  en: {
    ...
    rules: {
      ...
      race: [
        ...
        { id: 'stonefall', label: 'Stonefall', value: 'Starts at 20 seconds, then shortens by 1 to 10; a clearable rock pair falls at 2× speed in one column.' },
