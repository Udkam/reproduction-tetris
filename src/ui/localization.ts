...
const COPY: Record<AppLanguage, Translation> = {
  ...
  en: {
    ...
    introRules: {
      ...
      sprint: [
        { id: 'objective', label: 'Goal', value: 'Clear lines and use core pieces to reshape the board.' },
