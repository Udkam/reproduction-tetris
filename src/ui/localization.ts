...
type Translation = {
  ...
  phrasing: {
    ...
    currentRunRank: (rank: number) => string;
...
const COPY: Record<AppLanguage, Translation> = {
  'zh-CN': {
    ...
    phrasing: {
      ...
      currentRunRank: (rank) => `本局第 ${rank} 名`,
  ...
  en: {
    ...
    phrasing: {
      ...
      currentRunRank: (rank) => `This run · #${rank}`,
