...
const PUZZLE_LIBRARY: readonly PuzzleDefinition[] = Object.freeze([
  ...
  endgame('t3r-shaft-01', '开槽', 1, 994121443, setup(1588444911, [{ type: 'I', rotation: 0, x: 5 }, { type: 'O', rotation: 0, x: 1 }, { type: 'J', rotation: 1, x: -1 }, { type: 'S', rotation: 2, x: 3 }, { type: 'T', rotation: 1, x: 2 }, { type: 'Z', rotation: 2, x: 3 }, { type: 'L', rotation: 1, x: 5 }, { type: 'L', rotation: 0, x: 0 }]), [{ x: 3, y: 14 }]),
  endgame('t3r-shaft-02', '回转', 2, 2718281828, setup(1431655765, [{ type: 'T', rotation: 0, x: 7 }, { type: 'Z', rotation: 3, x: 7 }, { type: 'I', rotation: 3, x: 8 }, { type: 'O', rotation: 1, x: 5 }, { type: 'J', rotation: 3, x: 3 }, { type: 'S', rotation: 0, x: 1 }, { type: 'L', rotation: 2, x: 5 }, { type: 'S', rotation: 0, x: 3 }])),
  endgame('t3r-shaft-03', '错层', 3, 3141592653, setup(1717986918, [{ type: 'L', rotation: 1, x: 0 }, { type: 'J', rotation: 0, x: 4 }, { type: 'S', rotation: 3, x: 2 }, { type: 'I', rotation: 1, x: -2 }, { type: 'Z', rotation: 0, x: 0 }, { type: 'T', rotation: 3, x: 5 }, { type: 'O', rotation: 2, x: 7 }, { type: 'L', rotation: 2, x: 3 }])),
  endgame('t3r-shaft-04', '侧槽', 5, 1618033988, setup(2004318071, [{ type: 'S', rotation: 2, x: 0 }, { type: 'L', rotation: 1, x: 2 }, { type: 'I', rotation: 2, x: 6 }, { type: 'Z', rotation: 1, x: -1 }, { type: 'T', rotation: 3, x: 4 }, { type: 'J', rotation: 2, x: 0 }, { type: 'O', rotation: 2, x: 6 }, { type: 'O', rotation: 2, x: 3 }])),
  endgame('t3r-cascade-05', '双湾', 4, 1073741827, setup(305419896, [{ type: 'S', rotation: 3, x: 2 }, { type: 'T', rotation: 0, x: 5 }, { type: 'O', rotation: 3, x: 0 }, { type: 'I', rotation: 3, x: 3 }, { type: 'Z', rotation: 2, x: 7 }, { type: 'L', rotation: 1, x: -1 }, { type: 'J', rotation: 0, x: 1 }, { type: 'J', rotation: 0, x: 5 }])),

  // 06–10: six rows — read overhangs before committing a bridge or a side release.
  endgame('t3r-cascade-06', '折角', 6, 1717986918, setup(305419896, [{ type: 'S', rotation: 2, x: 0 }, { type: 'T', rotation: 1, x: -1 }, { type: 'O', rotation: 1, x: 3 }, { type: 'I', rotation: 2, x: 6 }, { type: 'Z', rotation: 2, x: 1 }, { type: 'L', rotation: 3, x: 3 }, { type: 'J', rotation: 1, x: 4 }, { type: 'J', rotation: 0, x: 0 }])),
  endgame('t5r-delta-07', '长槽', 7, 452198731, setup(1588444911, [{ type: 'I', rotation: 0, x: 2 }, { type: 'O', rotation: 1, x: 6 }, { type: 'J', rotation: 3, x: 8 }, { type: 'S', rotation: 2, x: 7 }, { type: 'T', rotation: 3, x: 4 }, { type: 'Z', rotation: 1, x: 5 }, { type: 'L', rotation: 2, x: 5 }, { type: 'L', rotation: 2, x: 1 }])),
  endgame('t5r-drift-08', '交错', 9, 2309737967, setup(878082202, [{ type: 'S', rotation: 0, x: 6 }, { type: 'T', rotation: 0, x: 3 }, { type: 'Z', rotation: 0, x: 4 }, { type: 'I', rotation: 3, x: -1 }, { type: 'O', rotation: 1, x: 1 }, { type: 'J', rotation: 2, x: 1 }, { type: 'L', rotation: 0, x: 2 }, { type: 'Z', rotation: 0, x: 0 }])),
  endgame('t5r-lattice-09', '搭桥', 8, 2004318071, setup(591751049, [{ type: 'L', rotation: 0, x: 6 }, { type: 'J', rotation: 0, x: 3 }, { type: 'S', rotation: 0, x: 4 }, { type: 'T', rotation: 1, x: 6 }, { type: 'I', rotation: 1, x: 7 }, { type: 'Z', rotation: 1, x: 7 }, { type: 'O', rotation: 3, x: 1 }, { type: 'I', rotation: 2, x: 3 }]), [{ x: 9, y: 13 }]),
  endgame('t5r-rift-10', '双仓', 10, 1311768467, setup(1588444911, [{ type: 'I', rotation: 2, x: 1 }, { type: 'O', rotation: 3, x: 5 }, { type: 'J', rotation: 0, x: 7 }, { type: 'S', rotation: 3, x: 8 }, { type: 'T', rotation: 1, x: 3 }, { type: 'Z', rotation: 0, x: 5 }, { type: 'L', rotation: 0, x: 7 }, { type: 'L', rotation: 0, x: 1 }])),

  // 11–15: seven rows — preserve recovery room while resolving paired cavities.
  endgame('t5r-prism-11', '盆地', 14, 3177056438, setup(878082202, [{ type: 'S', rotation: 2, x: 4 }, { type: 'T', rotation: 0, x: 1 }, { type: 'Z', rotation: 1, x: 0 }, { type: 'I', rotation: 1, x: -2 }, { type: 'O', rotation: 0, x: 3 }, { type: 'J', rotation: 0, x: 7 }, { type: 'L', rotation: 3, x: 0 }, { type: 'Z', rotation: 2, x: 4 }, { type: 'J', rotation: 0, x: 2 }, { type: 'T', rotation: 0, x: 3 }])),
  endgame('t5r-current-12', '双折', 13, 1832906719, setup(287454031, [{ type: 'L', rotation: 0, x: 7 }, { type: 'J', rotation: 3, x: 4 }, { type: 'T', rotation: 1, x: 2 }, { type: 'I', rotation: 1, x: 4 }, { type: 'S', rotation: 1, x: 6 }, { type: 'Z', rotation: 2, x: 7 }, { type: 'O', rotation: 1, x: 1 }, { type: 'S', rotation: 0, x: 5 }, { type: 'L', rotation: 2, x: 2 }, { type: 'T', rotation: 3, x: 8 }])),
  endgame('t5r-arc-13', '弧底', 12, 2882400001, setup(591751049, [{ type: 'L', rotation: 1, x: 7 }, { type: 'J', rotation: 0, x: 5 }, { type: 'S', rotation: 0, x: 6 }, { type: 'T', rotation: 0, x: 2 }, { type: 'I', rotation: 3, x: 8 }, { type: 'Z', rotation: 3, x: 1 }, { type: 'O', rotation: 2, x: 3 }, { type: 'I', rotation: 3, x: 4 }, { type: 'Z', rotation: 3, x: 6 }, { type: 'J', rotation: 1, x: 7 }])),
  endgame('t5r-pulse-14', '竖脊', 11, 3471557507, setup(1164413355, [{ type: 'J', rotation: 0, x: 3 }, { type: 'Z', rotation: 0, x: 3 }, { type: 'L', rotation: 0, x: 0 }, { type: 'T', rotation: 0, x: 6 }, { type: 'S', rotation: 2, x: 5 }, { type: 'I', rotation: 1, x: -2 }, { type: 'O', rotation: 2, x: 1 }, { type: 'L', rotation: 0, x: 3 }, { type: 'Z', rotation: 0, x: 2 }, { type: 'S', rotation: 3, x: 0 }])),
  endgame('t5r-horizon-15', '缺口', 15, 2596069104, setup(305419896, [{ type: 'S', rotation: 0, x: 1 }, { type: 'T', rotation: 1, x: 0 }, { type: 'O', rotation: 1, x: 4 }, { type: 'I', rotation: 3, x: -1 }, { type: 'Z', rotation: 0, x: 2 }, { type: 'L', rotation: 3, x: 4 }, { type: 'J', rotation: 0, x: 7 }, { type: 'J', rotation: 2, x: 0 }, { type: 'I', rotation: 1, x: 4 }, { type: 'T', rotation: 1, x: 2 }])),

  // 16–20: eight rows — plan release lanes across a true deep endgame.
  endgame('t6r-veil-16', '深槽', 20, 324508639, setup(1588444911, [{ type: 'I', rotation: 1, x: 0 }, { type: 'O', rotation: 0, x: 0 }, { type: 'J', rotation: 0, x: 3 }, { type: 'S', rotation: 3, x: 3 }, { type: 'T', rotation: 3, x: 0 }, { type: 'Z', rotation: 2, x: 5 }, { type: 'L', rotation: 3, x: 7 }, { type: 'L', rotation: 2, x: 0 }, { type: 'O', rotation: 2, x: 6 }, { type: 'Z', rotation: 2, x: 3 }, { type: 'T', rotation: 3, x: 4 }, { type: 'S', rotation: 2, x: 3 }])),
  endgame('t6r-cairn-17', '双坡', 16, 3735928559, setup(270544960, [{ type: 'T', rotation: 0, x: 2 }, { type: 'L', rotation: 1, x: 4 }, { type: 'S', rotation: 1, x: 2 }, { type: 'J', rotation: 1, x: 0 }, { type: 'Z', rotation: 0, x: 6 }, { type: 'I', rotation: 3, x: -1 }, { type: 'O', rotation: 3, x: 1 }, { type: 'I', rotation: 0, x: 4 }, { type: 'Z', rotation: 3, x: 0 }, { type: 'S', rotation: 1, x: 4 }, { type: 'J', rotation: 0, x: 2 }, { type: 'O', rotation: 0, x: 3 }])),
  endgame('t6r-terrace-18', '阶梯', 17, 5783321, setup(1164413355, [{ type: 'J', rotation: 0, x: 0 }, { type: 'Z', rotation: 2, x: 0 }, { type: 'L', rotation: 0, x: 3 }, { type: 'T', rotation: 3, x: 2 }, { type: 'S', rotation: 0, x: 0 }, { type: 'I', rotation: 1, x: 4 }, { type: 'O', rotation: 1, x: 4 }, { type: 'L', rotation: 1, x: 6 }, { type: 'Z', rotation: 0, x: 5 }, { type: 'S', rotation: 1, x: 2 }, { type: 'O', rotation: 1, x: 1 }, { type: 'J', rotation: 1, x: -1 }])),
  endgame('t6r-bastion-19', '交口', 19, 521288629, setup(591751049, [{ type: 'L', rotation: 0, x: 7 }, { type: 'J', rotation: 3, x: 5 }, { type: 'S', rotation: 1, x: 6 }, { type: 'T', rotation: 3, x: 8 }, { type: 'I', rotation: 2, x: 1 }, { type: 'Z', rotation: 1, x: 3 }, { type: 'O', rotation: 2, x: 2 }, { type: 'I', rotation: 2, x: 4 }, { type: 'Z', rotation: 3, x: 2 }, { type: 'J', rotation: 0, x: 7 }, { type: 'L', rotation: 0, x: 4 }, { type: 'O', rotation: 1, x: 8 }])),
  endgame('t6r-keystone-20', '基石', 18, 19088743, setup(305419896, [{ type: 'S', rotation: 2, x: 1 }, { type: 'T', rotation: 1, x: -1 }, { type: 'O', rotation: 3, x: 1 }, { type: 'I', rotation: 2, x: 6 }, { type: 'Z', rotation: 1, x: 4 }, { type: 'L', rotation: 3, x: 3 }, { type: 'J', rotation: 1, x: -1 }, { type: 'J', rotation: 2, x: 7 }, { type: 'I', rotation: 2, x: 3 }, { type: 'T', rotation: 0, x: 2 }, { type: 'L', rotation: 2, x: 2 }, { type: 'O', rotation: 0, x: 0 }, { type: 'S', rotation: 0, x: 7 }])),
]);
